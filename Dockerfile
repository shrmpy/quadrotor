...
RUN apt-get update; apt-get install -y \
            ...
            python-wstool ros-kinetic-joystick-drivers ros-kinetic-teleop-twist-keyboard ros-kinetic-geographic-msgs; \
...
RUN mkdir -p /root/catkin_ws/src; cd /root/catkin_ws; . /opt/ros/kinetic/setup.sh; \
